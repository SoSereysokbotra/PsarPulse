    ...
    <AuthLayout
      leftContent={
        <LeftPanelContent
          ...
          title={t("auth.signup.growTitle")}
          subtitle=""
          features={[
            {
              title: t("auth.signup.feature1Title"),
              desc: t("auth.signup.feature1Desc"),
            },
            {
              title: t("auth.signup.feature2Title"),
              desc: t("auth.signup.feature2Desc"),
            },
            {
              title: t("auth.signup.feature3Title"),
              desc: t("auth.signup.feature3Desc"),
            },
          ]}
