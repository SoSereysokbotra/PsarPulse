...
function VipRegistrationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log("VIP Registration:", { ...formData, token });
    setIsSuccess(true);
    setIsLoading(false);
  };
    ...
    return (
      <div className="w-full max-w-md mx-auto bg-white rounded-3xl p-10 shadow-xl border border-slate-100 text-center animate-in fade-in zoom-in-95 duration-500">
        ...
        <p className="text-slate-500 mb-8 leading-relaxed">
          Your VIP Vendor account has been successfully created. You can now
          access all premium features on the dashboard.
        </p>
        <Link
