    ...
    try {
      ...
      if (data.success) {
        ...
        setFeedback({
          ...
          message:
            data.message ||
            (isKhmer ? "មានបញ្ហាកើតឡើង។" : "An error occurred."),
        });
      }
    } catch {
      setFeedback({
            ...
            <div className="p-6 space-y-4">
              ...
              >
                <div className="grid grid-cols-[120px_1fr] gap-x-4 gap-y-3 text-sm">
                  ...
                  >
                    {selectedRequest.fullName || (isKhmer ? "មិនមាន" : "N/A")}
                  </span>
                  ...
                  <span
                    className={`leading-relaxed ${isDark ? "text-slate-300" : "text-slate-800"}`}
                  >
