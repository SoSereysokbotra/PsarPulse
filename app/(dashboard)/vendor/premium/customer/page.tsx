    ...
    >
      ...
      <main className="flex-1 flex flex-col w-full min-w-0 h-screen overflow-hidden">
        <VendorTopbar
          ...
          rightActions={
            <button
              className={`hidden sm:flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-xl transition-colors ${isDark
          ...
          <div className={`flex gap-6 border-b transition-colors ${isDark ? "border-white/5" : "border-slate-200"}`}>
            {TABS.map((tab) => (
              <button
                ...
                className={`pb-3 flex flex-col items-start transition-colors ${activeTab === tab.id
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              >
                <button
                  ...
                  className={`px-3 py-2 transition-colors min-h-11 ${isDark
              ...
              <button
                className={`px-4 py-2 text-sm font-medium rounded-xl transition-colors min-h-11 border ${isDark
          ...
          >
            ...
            >
              ...
              <div className="relative w-full sm:w-auto">
                ...
                <input
                  ...
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className={`w-full pl-9 pr-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-1 focus:ring-[#29B28D] min-h-11 transition-colors ${isDark
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr
                    className={`border-b text-xs uppercase tracking-wider font-semibold transition-colors ${isDark
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {log.status === "Peak Traffic" ? (
                          ...
                          <span
                            className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold border ${isDark
            ...
            <div className="flex gap-4 mt-8">
              <button
                ...
                className={`flex-1 py-3.5 rounded-xl font-bold text-sm transition-all ${isDark ? "bg-white/5 text-slate-400 hover:text-white" : "bg-slate-100 text-slate-500"
                  }`}
              >
                Cancel
              </button>
