...
export const AuthLayout = ({
  ...
  <div className="min-h-screen w-full flex flex-col lg:flex-row font-sans bg-psar-white selection:bg-psar-primary selection:text-white">
    {/* Left Panel */}
    <div className="hidden lg:flex lg:w-5/12 bg-psar-dark relative overflow-hidden flex-col justify-between p-12 lg:p-16 text-white border-r-4 border-psar-primary shadow-2xl z-10">
    ...
    {/* Right Panel */}
    <div className="flex-1 flex flex-col justify-center relative bg-psar-white py-12 px-6 sm:px-12 lg:px-20 xl:px-32">
      {/* Top navigation */}
